...
include::{snippets}/전체 에러코드 모음/all-error-codes.adoc[]
...
include::{snippets}/게시글 memberId로 조회/http-request.adoc[]
include::{snippets}/게시글 memberId로 조회/path-parameters.adoc[]
include::{snippets}/게시글 memberId로 조회/query-parameters.adoc[]

==== 응답

include::{snippets}/게시글 memberId로 조회/http-response.adoc[]
include::{snippets}/게시글 memberId로 조회/response-fields.adoc[]
...
include::{snippets}/댓글 memberId로 조회/http-request.adoc[]
include::{snippets}/댓글 memberId로 조회/path-parameters.adoc[]
include::{snippets}/댓글 memberId로 조회/query-parameters.adoc[]

==== 응답

include::{snippets}/댓글 memberId로 조회/http-response.adoc[]
include::{snippets}/댓글 memberId로 조회/response-fields.adoc[]
